...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <input type="text" name="ma_the_loai" value="<?= htmlspecialchars($theloai['ma_the_loai']) ?>" readonly><br>
            <label>Tên thể loại</label><br>
            <input type="text" name="the_loai" value="<?= htmlspecialchars($theloai['the_loai']) ?>" required><br>
